...
import { 
  ...
  FileText, ArrowLeftRight, ArrowDown, ArrowUp, Package
} from 'lucide-react';
  ...
  return (
    <div className="px-4 py-6 pb-32 space-y-8 animate-fade-in min-h-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <HomeKitCard 
           title="دفتر السبائك" 
           subtitle="سجل حركات السبائك والجنيهات"
           icon={<Package />} 
           colorTheme="gold"
           to="/bullions"
        />
      ...
      {showTransferScrap && createPortal(
         <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-6 animate-fade-in" dir="rtl">
            <div className="bg-[#1e293b] border border-white/10 w-full max-w-sm rounded-[2rem] p-6 shadow-2xl relative animate-scale-in">
      ...
      {showScrapDetails && createPortal(
         <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 animate-fade-in" dir="rtl">
            <div className="bg-[#1e293b] border border-white/10 w-full max-w-lg rounded-[2rem] p-6 shadow-2xl relative max-h-[85vh] flex flex-col animate-scale-in">
