        ...
        <div className="bg-gray-900 border border-gray-800 rounded-[2.5rem] shadow-2xl overflow-hidden relative z-10">
          <div className="p-8 pb-4 text-center flex flex-col items-center">
            <div className="mb-4 relative group cursor-pointer">
              <div className="absolute inset-0 bg-gold-500/20 rounded-[24%] blur-lg opacity-40 group-hover:opacity-75 transition-opacity duration-300"></div>
              <AppIcon size={80} className="relative z-10 drop-shadow-xl hover:scale-110 transition-transform duration-300" />
            </div>
            <h1 className="text-2xl font-bold text-white mt-1">تسجيل الدخول</h1>
