...
export const AIPriceAnalyst = () => {
  ...
  const runAnalysisSequence = async () => {
      ...
      // ملاحظة للتوضيح (الشفافية - البند 9): 
      // هذا التسلسل هو تمثيل بصري (Visual Simulation) لتحسين تجربة المستخدم وإعطاء إحساس بالعمق التحليلي.
      // فعلياً، التطبيق يجلب البيانات من مصدرين أساسيين (Isagha و Edahab) كما هو موضح في storage.ts.
      const sources = [
